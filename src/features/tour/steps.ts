...
export const TOUR_STEPS: TourStep[] = [
  ...
  { id: 'assessment', title: 'Assessment and Expert Guidance', personaId: 'per-nok', path: '/assessment', target: 'assessment-self',
    what: 'Nok, a payroll supervisor whose diagnostic is pending, rates herself on the critical skills, answers a knowledge check and describes her role. Expert Guidance then drafts her gap map and personal path for review.',
    why: 'Phase 0 starts from the learner\'s real gaps and the BU priority, ranked by skill gap × role relevance × project need.',
    benefit: 'Personalised journeys from day one; coaching points reach the human coach before clinic 1.' },
  ...
  { id: 'labs', title: 'Applied capability labs', personaId: 'per-nara', path: '/labs', target: 'lab-4',
    what: 'Four in-person lab days with agenda, live SCG case, tools, deliverable and pre-work status. Learners check in and record what they take back to work; Lab Day 4 ends with the impact contract.',
    why: 'Class time becomes 70% practice on real cases with real AI tools; the same tools are applied at work.',
    benefit: 'Labs hand off directly into the 90-day sprint.' },
