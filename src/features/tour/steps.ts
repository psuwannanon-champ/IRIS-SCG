...
export const TOUR_STEPS: TourStep[] = [
  ...
  { id: 'ledger', title: 'Sponsor validation and the impact ledger', personaId: 'per-prasert', path: '/ledger', target: 'gov-stats',
  ...
  { id: 'briefs', title: 'Challenge briefs for BCD', personaId: 'per-chatchai', path: '/briefs', target: 'brief-actions',
