...
export function CoachingPage() {
  ...
  return (
    <>
      <PageHeader title="Coaching workspace" description="Your clinics, learners and teams, the AI-coach flags that need follow-up, and your quality scorecard. Add a note or mark a briefing ready to clear a task." />
