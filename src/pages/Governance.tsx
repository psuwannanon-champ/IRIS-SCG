    ...
    <>
      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-2">
        <Section title="By business unit" icon="building-07" description="Validated ledger value, learners and share of enrolled critical-role holders with a verified skill.">
          <div className="table-grid grid-cols-[minmax(0,1.6fr)_110px_90px_90px_100px] px-1 pb-1 text-[11px] font-semibold uppercase tracking-wide text-(--color-faint)"><div>BU</div><div>Validated</div><div>Learners</div><div>Graduates</div><div>Skill-ready</div></div>
          <ul className="divide-y divide-(--color-border)">
            {byBu.map((r) => (
              <li key={r.b.id} className="table-grid grid-cols-[minmax(0,1.6fr)_110px_90px_90px_100px] px-1 py-2 text-[13px]">
