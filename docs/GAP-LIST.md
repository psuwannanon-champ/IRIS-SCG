...
**30 of 31 closed.** Item 20 stays open: it needs promotion events from the HR core, which the demo dataset does not contain. Items 25 to 31 were found in three further full reads of the deck after the first sweep, and are all closed.
